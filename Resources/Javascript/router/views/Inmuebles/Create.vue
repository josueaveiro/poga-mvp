          ...
          >
            ...
            >
              ...
              <b-field
                ...
                :message="getErrorMessage(['id_inmueble.area', 'area'])"
                :type="setFieldType(['id_inmueble.area', 'area'])"
              >
                <b-input
                  v-model="form.id_inmueble.area"
...
export default {
    ...
    data() {
        return {
            ...
            prepared: false,
            submitted: false,
            title: "Comencemos a registrar tu Inmueble",
            url: app.apiUrl + "/inmuebles"
        }
    },
